...
app.config["MYSQL_HOST"] = 'loocalhost'
app.config["SECRET_KEY"] = '123' ## secret key for sessions (signed cookies). Flask uses it to protect the contents of the user session against tampering.
